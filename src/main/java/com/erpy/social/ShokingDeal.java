 ...
 */
public class ShokingDeal {
    private static Logger logger = Logger.getLogger(ShokingDeal.class.getName());
...
//            System.out.println("===========================================");
    ...
    public static void main(String args[]) throws Exception {
        ...
        crawlSite.setCrawlUrl("http://m.11st.co.kr/MW/Shockingdeal/categoryProductList.tmall?dispCtgrNo=947158&dispCtgrLevel=1&lDispCtgrNo=947158&pageSize=60");
