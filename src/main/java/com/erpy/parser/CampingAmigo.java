 ...
 */
public class CampingAmigo {
    private static Logger logger = Logger.getLogger("CampingAmigo");
    ...
    //
    private static final String prefixContentUrl = "http://www.campingamigo.com";
    private static final String prefixHostThumbUrl = "http://www.campingamigo.com";
    ...
    public Map<String, SearchData> extract(CrawlData crawlData) throws Exception {
        ...
        for (Element element : elements) {
            ...
            // org price
            listE = document.select("div[style*=\"padding-bottom:3px\"]");
            for (Element et : listE) {
            ...
            // set cp name.
            searchData.setCpName(GlobalInfo.CP_CampingAmigo);
            // set keyword.
    ...
    public void mainExtractProcessing(CampingAmigo cp,
                                      CrawlData crawlData,
    ...
    public static void main(String args[]) throws Exception {
        ...
        crawlSite.setCrawlUrl("http://www.campingamigo.com/shop/goods/goods_list.php?&category=001001");
