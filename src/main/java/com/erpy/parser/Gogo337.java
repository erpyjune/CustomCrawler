 ...
 */
public class Gogo337 {
    private static Logger logger = Logger.getLogger("Gogo337");
    ...
    //
    private static final String prefixContentUrl = "http://www.gogo337.co.kr";
    private static final String prefixHostThumbUrl = "http://www.gogo337.co.kr";
    ...
    public Map<String, SearchData> extract(CrawlData crawlData) throws Exception {
        ...
        for (Element element : elements) {
            ...
            if (!element.outerHtml().contains("Brand_prodtHeight"))
                continue;
...
//            }
            ...
            // set cp name.
            searchData.setCpName(GlobalInfo.CP_Gogo337);
            // set keyword.
    ...
    public void mainExtractProcessing(Gogo337 cp,
                                      CrawlData crawlData,
    ...
    public void thumbnailProcessing(String cpName, boolean isAllData) throws Exception {
        ...
        String prefixHostThumbUrl="http://www.gogo337.co.kr";
        String hostDomain = "www.gogo337.co.kr";
...
//            logger.info("cp_name  : " + searchData.getCpName());
            ...
            elements = doc.select("td[style=\"padding:5 0 5 0\"]");
            for (Element element : elements) {
                if (!element.outerHtml().contains("/shopimages/"))
                    continue;
                document = Jsoup.parse(element.outerHtml());
