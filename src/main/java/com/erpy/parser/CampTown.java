...
public class CampTown {
    ...
    public void thumbnailProcessing(String cpName) throws Exception {
        ...
        String prefixHostThumbUrl = "http://www.camptown.co.kr";
        String referer = "http://www.camptown.co.kr";
        String hostDomain = "www.camptown.co.kr";
...
//            logger.info("cp_name  : " + searchData.getCpName());
            ...
            elements = doc.select("div.slides_container");
            for (Element element : elements) {
