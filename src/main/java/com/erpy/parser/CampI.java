...
public class CampI {
    ...
    private static final String pattern = "td[width=130] a font[STYLE=\"color:#555555;font-size:12px;font-style:normal;font-weight:normal\"]";
    // for crawling.
...
//            }
    ...
    public void crawlData(String url, String strKeyword, String strCpName) throws Exception {
        ...
        for(;;) {
            ...
            strUrl = String.format("%s&page=%d&offset=%d", url, page, offset);
