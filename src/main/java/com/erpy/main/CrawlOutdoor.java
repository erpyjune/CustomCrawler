...
//        CrawlMainThread crawlMainThread = new CrawlMainThread();
        ...
        while (iterator.hasNext()) {
            ...
            if (seed.getCpName().equals(GlobalInfo.CP_OKMALL)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_FIRST)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_CAMPINGMALL)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_SBCLUB)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
...
//                crawlMainThread.setHttpRequestHeader(httpRequestHeader.getHttpRequestHeader());
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_CCAMPING)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_CAMPINGON)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_CampTown)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_Aldebaran)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_OMyCamping)) { // 사이트 개편되었음.
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_CampI)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_Camping365)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_LeisureMan)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_WeekEnders)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_CampingPlus)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_Starus)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_CampSchule)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_TongOutdoor)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_AirMT)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_Gogo337)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_Totooutdoor)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_Niio)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_YahoCamping)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_CampingAmigo)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
                ...
                crawlMainThread.setAllCrawlDatas(allCrawlDatas);
                crawlMainThread.run();
            }  else if (seed.getCpName().equals(GlobalInfo.CP_GoodCamping)) {
                CrawlMainThread crawlMainThread = new CrawlMainThread();
